...
function calculate(){
    document.getElementById("changeTxt").innerHTML="With a starting principle of $" + prin + " and with a growth rate of " + intRate + "% for " + varTime + " years, your total interest will be " + prin*halfAnEquation;
}